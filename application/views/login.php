	...
	<div class="container" id="container">
		...
		<div class="form-container sign-up">
			<form method="post" action="<?= base_url('Auth/regis'); ?>">
				...
				<input type="num" placeholder="NIP" name="nip" />
				<?= form_error('nip', '<span class="text-danger small ml-2">', '</span>'); ?>

				<input type="text" placeholder="Nama" name="username" />
				<?= form_error('username', '<span class="text-danger small ml-2">', '</span>'); ?>

				<input type="password" placeholder="Password" name="password" />
				<?= form_error('password', '<span class="text-danger small ml-2">', '</span>'); ?>
