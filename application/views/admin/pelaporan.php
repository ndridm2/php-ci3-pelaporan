...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Kelola Data Pelaporan Kinerja</h1>
	</div>
	<!-- Page Heading -->
	<div class="mt-5"></div>
					...
					foreach ($item as $i) : ?>
						<tr>
							...
							<td style="width: 8px;text-align: center;vertical-align: middle;">
								...
								<?= anchor('admin/pelaporan/hapus/' . $i['pelaporan_id'], '<div class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></div>') ?>
							</td>
						</tr>
					<?php endforeach; ?>
